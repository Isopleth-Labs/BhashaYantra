...
<table>
  <tr>
    ...
    <td align="center"><strong>96</strong><br /><sub>automated tests</sub></td>
  </tr>
</table>
...
- 89 frontend tests, 7 native tests, strict TypeScript/Rust checks, production build, and visual QA.
- Pinned CI actions, CodeQL and dependency audits, SHA-256 checksums, build provenance, CSP, scoped native capabilities, and release signing gates.
- Versioned beta Privacy, Terms, Support, Security, and source-available evaluation documents.
...
- Qualified legal review, monitored private support/privacy channel, and beta feedback consent.
...
- [Supabase login activation](docs/12-supabase-login-activation.md)

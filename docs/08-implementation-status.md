...
- Academy-style staged practice with an immediately open lesson catalog, phase/module position, multi-block drills, optional one-to-three clean-pass mastery tracking, named objectives, recommended WPM, Free/Pro labels, next-key/finger guidance, clickable keyboard, error sound, text size, and backspace controls.
